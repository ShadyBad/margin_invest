...
class TestV4Orchestrator:
    ...
    def test_only_track_a_qualifies(self):
        result = orchestrate_v4(
            "TEST",
            track_a=self._make_track("compounder", True, CompositeTier.HIGH),
            track_b=self._make_track("mispricing", False, CompositeTier.NONE),
            track_c=self._make_track("efficient_growth", False, CompositeTier.NONE),
    ...
    def test_only_track_c_qualifies(self):
        result = orchestrate_v4(
            "TEST",
            track_a=self._make_track("compounder", False, CompositeTier.NONE),
            track_b=self._make_track("mispricing", False, CompositeTier.NONE),
            track_c=self._make_track("efficient_growth", True, CompositeTier.HIGH),
            timing_signal="buy_now",
        )
    ...
    def test_track_a_plus_b_both_promotion(self):
        result = orchestrate_v4(
            "TEST",
            track_a=self._make_track("compounder", True, CompositeTier.HIGH),
            track_b=self._make_track("mispricing", True, CompositeTier.HIGH),
            track_c=self._make_track("efficient_growth", False, CompositeTier.NONE),
            timing_signal="buy_now",
        )
    ...
    def test_position_sizing_compounder_growth_exceptional(self):
        result = orchestrate_v4(
            "TEST",
            track_a=self._make_track("compounder", True, CompositeTier.EXCEPTIONAL),
            track_b=self._make_track("mispricing", False, CompositeTier.NONE),
            track_c=self._make_track("efficient_growth", True, CompositeTier.HIGH),
            timing_signal="buy_now",
        )
