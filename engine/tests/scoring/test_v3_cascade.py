    ...
    def test_returns_v3_track_result(self):
        result = run_track_b_cascade(
            TrackBInputs(
                ...
                insider_percentile=60.0,
                institutional_percentile=70.0,
                sue_percentile=50.0,
                wacc=0.10,
                regime_adjustments=None,
            )
    ...
    def test_overvalued_stock_fails(self):
        ...
        result = run_track_b_cascade(
            TrackBInputs(
                ...
                asset_floor_iv=90.0,
                peer_comparison_iv=105.0,
                insider_percentile=20.0,
                institutional_percentile=10.0,
                sue_percentile=15.0,
                wacc=0.10,
                regime_adjustments=None,
            )
    ...
    def test_regime_adjustments_accepted(self):
        ...
        result = run_track_b_cascade(
            TrackBInputs(
                ...
                asset_floor_iv=90.0,
                peer_comparison_iv=105.0,
                insider_percentile=70.0,
                institutional_percentile=60.0,
                sue_percentile=50.0,
                wacc=0.10,
                regime_adjustments=adj,
            )
