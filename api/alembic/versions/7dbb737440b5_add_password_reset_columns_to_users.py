...
def upgrade() -> None:
    ...
    op.create_table('linked_providers',
        ...
        sa.UniqueConstraint('provider', 'oauth_id', name='uq_linked_providers_provider_oauth_id'),
        sa.UniqueConstraint('user_id', 'provider', name='uq_linked_providers_user_id_provider'),
    )
