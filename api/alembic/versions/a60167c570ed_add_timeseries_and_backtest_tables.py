...
def upgrade() -> None:
    ...
    if bind.dialect.name == "postgresql":
        ...
        if has_timescale:
            ...
            """)
            op.execute("SELECT add_compression_policy('prices_intraday', INTERVAL '7 days')")
            op.execute("""
    ...
    op.create_foreign_key(
        "scores_universe_snapshot_id_fkey",
        "scores",
        "universe_snapshots",
        ["universe_snapshot_id"],
        ["id"],
