...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_credential_users_email"),
        "credential_users",
        ["email"],
        unique=True,
    )
    op.create_index(
        op.f("ix_credential_users_username"),
        "credential_users",
        ["username"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "asset_id",
            "period_end",
            name="uq_financial_data_asset_period",
        ),
    )
    op.create_index(
        op.f("ix_financial_data_asset_id"),
        "financial_data",
        ["asset_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_recommendations_asset_id"),
        "recommendations",
        ["asset_id"],
        unique=False,
    )
