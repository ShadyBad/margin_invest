"""Tests for macro data client — Shiller CAPE fetching."""
...
import pytest
from margin_api.data.macro_data_client import _DEFAULT_CAPE, fetch_shiller_cape
...
class TestFetchShillerCape:
    ...
    async def test_returns_float(self):
        ...
        with patch("margin_api.data.macro_data_client._fetch_from_fred", new_callable=AsyncMock) as mock:
